...
public class QanonActivity extends AppCompatActivity {
    ...
    ImageView qanon_img;
    String uri;
    TextView txt_qanon,txt_controller;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (id)
        {
            case 0:
                ...
                txt_controller.setText("نوایی از ساز سه\u200Cتار");
            ...
            case 1:
                ...
                txt_controller.setText("نوایی از ساز تار");
            ...
            case 2:
                ...
                txt_controller.setText("نوایی از ساز تنبک");
            ...
            case 3:
                ...
                txt_controller.setText("نوایی از ساز قانون");
            ...
            case 4:
                ...
                txt_controller.setText("نوایی از ساز سنتور");
        ...
        player.addListener(new Player.EventListener() {
            ...
            public void onPlayerError(ExoPlaybackException error) {
                AlertDialog.Builder builder = new AlertDialog.Builder(QanonActivity.this);
